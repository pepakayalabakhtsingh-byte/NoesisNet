    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-background-light dark:bg-background-dark p-4 relative overflow-hidden">
            ...
            <div className="absolute inset-0 z-0 pointer-events-none overflow-hidden opacity-40 dark:opacity-20">
                <div className="absolute bottom-0 left-1/4 w-[40rem] h-[40rem] bg-secondary-400 rounded-full mix-blend-multiply filter blur-[100px] animate-blob"></div>
                <div className="absolute top-0 right-1/4 w-[40rem] h-[40rem] bg-primary-400 rounded-full mix-blend-multiply filter blur-[100px] animate-blob animation-delay-2000"></div>
            </div>
            ...
            <div className="relative z-10 w-full max-w-md flex flex-col items-center">
                ...
                >
                    <div className="text-center mb-8">
                        ...
                        <p className="text-slate-500 dark:text-slate-400">Join NoesisNet and start building your graph</p>
                    </div>
